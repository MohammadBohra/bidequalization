...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/aramco/formulaadminapp/test/integration/FirstJourney",
    "com/aramco/formulaadminapp/test/integration/BidFormulaListJourney",
    "com/aramco/formulaadminapp/test/integration/BidFormulaObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
